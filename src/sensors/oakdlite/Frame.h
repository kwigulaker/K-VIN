...
#ifndef _FAST_DDS_GENERATED_FRAME_H_
#define _FAST_DDS_GENERATED_FRAME_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(Frame_SOURCE)
#define Frame_DllAPI __declspec( dllexport )
#else
#define Frame_DllAPI __declspec( dllimport )
#endif // Frame_SOURCE
#else
#define Frame_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
...
#endif // _FAST_DDS_GENERATED_FRAME_H_